...
public class DumbbellRowController {
    ...
    @PostMapping()
    public boolean createDumbbellRow() {
    ...
    @GetMapping("/{id}")
    public boolean readDumbbellRowDataById(@PathVariable long id) {
        return backExerciseService.read();
    }
    ...
    @PutMapping("/{id}")
    public boolean updateDumbbellRowMinWeightData(@PathVariable long id) {
        return backExerciseService.read();
    }
    ...
    @DeleteMapping("/{id}")
    public boolean deleteDumbbellRowMinWeightData(@PathVariable long id) {
        return backExerciseService.read();
    }
